...
import { getFirestore, doc, getDoc, setDoc, onSnapshot, addDoc } from "firebase/firestore"; // addDoc is for Firestore
import { getDatabase, ref, get, set, onValue } from "firebase/database"; // Realtime Database imports
...
export { db, doc, getDoc, setDoc, onSnapshot, addDoc, realtimeDb, ref, get, set, onValue };
