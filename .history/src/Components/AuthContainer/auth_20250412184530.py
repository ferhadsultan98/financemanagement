...
cred = credentials.Certificate("src/Components/AuthContainer/config/finance.json")  # Your Firebase credentials
initialize_app(cred)
db = firestore.client()
...
def send_password():
    ...
    try:
        # Fetch user email from Firestore credentials collection
