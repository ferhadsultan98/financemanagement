      ...
      <ul>
        <li>
          <NavLink to="/" end>
            ...
            <span className="nav-label">{t("navbar.main")}</span>
          </NavLink>
        </li>
        <li>
          <NavLink to="/add-expense">
            <span className="nav-icon"><FaPlusCircle /></span>
            <span className="nav-label">{t("navbar.addexpense")}</span>
          </NavLink>
        </li>
        <li>
          <NavLink to="/expense-details">
            <span className="nav-icon"><FaListAlt /></span>
            <span className="nav-label">{t("navbar.expensedetails")}</span>
          </NavLink>
        </li>
        <li>
          <NavLink to="/about">
            <span className="nav-icon"><FaInfoCircle /></span>
            <span className="nav-label">{t("navbar.websiteabout")}</span>
          </NavLink>
        </li>
      </ul>
    </nav>
