...
const Registration = ({ setActiveForm }) => {
  ...
  const handleRegistration = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://financemanagement-g7dq.onrender.com/send-otp",
        { username, email },
        {
          headers: {
  ...
  const handleVerifyOTP = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://financemanagement-g7dq.onrender.com/verify-otp",
        { username: registrationData.username, otp },
        {
          headers: {
            "Content-Type": "application/json",
          },
      ...
      if (response.data.message) {
        ...
        await axios.post(
          "https://financemanagement-g7dq.onrender.com/send-welcome",
          {
            username: registrationData.username,
            email: registrationData.email,
            password: registrationData.password,
