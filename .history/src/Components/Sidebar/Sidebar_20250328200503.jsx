...
import { realtimeDb, ref, get, set, onValue } from "../../Backend/Firebase"; // Import Realtime Database functions
...
const Sidebar = () => {
  ...
  useEffect(() => {
    ...
    const userRef = ref(realtimeDb, 'users/' + username); // Path to user data in Realtime Database
  ...
  const handleTopUp = async () => {
    ...
    try {
      ...
      await set(userRef, { profile: userProfile, balance: newBalance }); // Update the balance in Realtime Database
      setTopUpAmount("");
