    ...
    <div className="authContainer">
      <div className="authWrapper">
        <div className="auth-left">
          <h1>{t("registration.left.title")}</h1>
          <DotLottieReact
          ...
          />
          <ul>
            <li>{t("registration.left.features.real_time")}</li>
            <li>{t("registration.left.features.records")}</li>
            <li>{t("registration.left.features.profile")}</li>
          </ul>
          <p>{t("registration.left.description")}</p>
          <div className="auth-left-footer">
            <p>{t("registration.left.footer")}</p>
          </div>
        </div>
