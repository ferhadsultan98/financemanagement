...
const Sidebar = () => {
  ...
  const [userProfile, setUserProfile] = useState(null); // Varsayılan değer kaldırıldı
    ...
    const fetchInitialData = async () => {
      try {
        ...
        if (snapshot.exists()) {
          ...
          setUserProfile(data.profile || { firstName: "", lastName: "", birthDate: "", gender: "" });
          setBalance(data.balance || 0);
        } else {
          const defaultProfile = { firstName: "", lastName: "", birthDate: "", gender: "" };
          await set(userRef, { profile: defaultProfile, balance: 0 });
