...
const AddExpense = () => {
  ...
  useEffect(() => {
    ...
    const unsubscribeExpenses = onValue(expensesRef, (snapshot) => {
      if (snapshot.exists()) {
        ...
        // Sort by date (newest first) and get last 3
  ...
  const handleSubmit = async (e) => {
    ...
    if (expenseAmount > balance) {
      ...
      toast.error(
        `Kifayət qədər balans yoxdur! ${eksik.toFixed(2)} ₼ çatışmır!`,
        {
          position: "top-right",
          autoClose: 3000,
        }
    ...
    try {
      ...
      toast.success(
        `${expenseAmount} ₼ xərc əlavə edildi! ${category} kateqoriyasına xərcləndi. Qalan balans: ${newBalance.toFixed(
          2
        )} ₼`,
        {
          position: "top-right",
                ...
                {recentExpenses.map((expense) => (
                  <div key={expense.id} className="expense-item">
                    <div
                      ...
                      style={{
                        backgroundColor:
                          categoryColors[expense.category] || "#34495e",
                      }}
                    >
                      <i
                        className={
                          categoryIcons[expense.category] || "fas fa-tag"
                        }
                      ></i>
                    </div>
          ...
          <div className="expense-tips">
            ...
            <div className="tips-content">
              <div className="tip-item">
                ...
                <p>
                  Aylıq gəlirinizin 50/30/20 faizini müvafiq olaraq ehtiyaclara,
                  istəklərə və qənaətə ayırın.
                </p>
              </div>
              <div className="tip-item">
                <i className="fas fa-chart-pie"></i>
                <p>
                  Xərclərin kateqoriyalara bölünməsi büdcənizi idarə etməyə
                  kömək edəcək.
                </p>
              </div>
              <div className="tip-item">
                ...
                <p>
                  Qənaət etmək əvvəlcə çətin görünə bilər, lakin mütəmadi olaraq
                  kiçik məbləğlər toplamaq böyük fərq yarada bilər.
                </p>
              </div>
            </div>
          </div>
