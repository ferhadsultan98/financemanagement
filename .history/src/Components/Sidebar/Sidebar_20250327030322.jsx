...
const Sidebar = () => {
  ...
  useEffect(() => {
    const fetchBalance = async () => {
      const userDocRef = doc(db, 'users', 'user-id'); // 'user-id' yerine dinamik bir ID kullanılabilir
  ...
  const handleTopUp = async () => {
    ...
    await setDoc(userDocRef, { balance: newBalance, profile: userProfile }, { merge: true });
