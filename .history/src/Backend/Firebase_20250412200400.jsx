...
import { getFirestore, doc, getDoc, setDoc, onSnapshot, addDoc, collection, getDocs, updateDoc } from "firebase/firestore";


import { getDatabase, ref, get, set, onValue, child, getDatabase } from "firebase/database"; 
...
export { db, doc, getDoc, setDoc, onSnapshot, addDoc, collection, getDocs, realtimeDb, ref, get, set, onValue, child, updateDoc, getDatabase };
